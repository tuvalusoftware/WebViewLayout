...
extension DataViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.setData(id: indexPath.row + 1, type: "data")
        return cell
    }
}

extension DataViewController: UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        layoutDelegate?.DataItemChoosed!(id: indexPath.row + 1)
    }
